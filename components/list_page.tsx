      ...
      <ScrollView
        ...
        >
          ...
          <TouchableOpacity style={styles.container} onPress={() => {router.push('/(details)/detail')}} > 
            <View style={styles.boxImage}>
                ...
                <Text style={styles.Titre} numberOfLines={1} ellipsizeMode="tail"> Manque de livre </Text>

                <View style={styles.Locate}>
                    <View style={styles.boxLocate}>
                        <Ionicons name='cash-outline' size={16} color={Colors.primaryColor} />
                        <Text style={styles.montant}> 100.000 FCFA  </Text>
                    </View>
          ...
          <TouchableOpacity style={styles.container} onPress={() => {router.push('/(details)/detail')}} > 
            <View style={styles.boxImage}>
              ...
              <Text style={styles.Titre} numberOfLines={1} ellipsizeMode="tail"> Opération couteuse </Text>
        ...
        <TouchableOpacity style={styles.container} onPress={() => {}} > 
            <View style={styles.boxImage}>
              ...
              <Text style={styles.Titre} numberOfLines={1} ellipsizeMode="tail"> Africa Help </Text>

              <View style={styles.Locate}>
                <View style={styles.boxLocate} >
                  <Ionicons name='cash-outline' size={16} color={Colors.primaryColor} />
                  <Text style={styles.montant}> 450.000 FCFA  </Text>
                </View>
                <View style={styles.progressContainer}>
                      <AnimatedCircularProgress
                        size={30}
